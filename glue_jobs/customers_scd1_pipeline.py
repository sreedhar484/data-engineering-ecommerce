...
# Paths
bronze_path = "s3://learning-data-engineering-7799/ecommerce-data/bronze/bronze/customers/customers_dataset.csv"
silver_path = "s3://learning-data-engineering-7799/ecommerce-data/silver/customers/"
